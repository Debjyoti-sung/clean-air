...
export default function FinalImplementation({ report, onClose, setReports }) {
  ...
  return (
    <div className="w-full bg-[#f1f5f9]/95 backdrop-blur-lg border-t border-slate-250/60 p-6 shadow-md z-20 flex flex-col items-center">
      ...
      <button 
        ...
        disabled={!allTasksDone || isCompleting}
      ...
      >
        ...
        <span>{isCompleting ? 'Generating Completion Certificate...' : 'Complete Resolution'}</span>
      </button>
    </div>
  );
}
