          ...
          <div className="lg:col-span-7 flex flex-col space-y-10 text-left lg:pl-10 order-1 lg:order-2">
            <div className="space-y-6">
              ...
              <p className="text-[17px] text-slate-500 font-medium leading-relaxed max-w-2xl">
                CleanAir is engineered as a robust, resilient digital backbone for municipalities, pollution control boards, and environmental researchers. By integrating crowdsourced alerts with advanced space-based monitoring, we remove systemic delays in identifying and resolving air violations.
              </p>
            </div>
